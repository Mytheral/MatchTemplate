...
{
	Bitmap returnInit = null;
	Bitmap returnFinal = null;
	...
	public TemplateMatching(Bitmap initFile, Bitmap finalFile, Bitmap templateFile, int match_method) 
	{
        ...
        for (int i=0; i<3; i++)
        {
	        ...
	        Core.rectangle(initImg, matchLoc, new Point(matchLoc.x + templateImg.cols(), matchLoc.y + templateImg.rows()), new Scalar(0, 255, 0), -1);
        }
